-- Complete fix for user_role enum issue
-- This migration ensures the user_role enum exists globally and all dependencies work
...
-- Create simplified handle_new_user function with explicit schema references
